...
var KTAppCalendar = function () {
            ...
            events: [
                {
                    ...
                    description: 'Nulla bibendum sagittis mattis. Cras non suscipit tellus. Integer gravida porttitor ante, sed iaculis orci molestie ac.',
            ...
            form,
            {
                fields: {
                    'calendar_event_name': {
                        validators: {
                            notEmpty: {
                                message: 'Укажите название урока'
                            }
                        }
                    },
                    'calendar_event_start_date': {
                        validators: {
                            notEmpty: {
                                message: 'Укажите время начала урока'
                            }
                        }
                    },
                    'calendar_event_end_date': {
                        validators: {
                            notEmpty: {
                                message: 'Укажите время окончания урока'
                            }
                        }
                    }
                },
    ...
    const handleNewEvent = () => {
        // Update modal title
        modalTitle.innerText = "Добавить урок на эту дату";
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        // Show popup warning 
                        Swal.fire({
                            text: "Ошибка, пожалуйста проверьте правильность введенных данных.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Хорошо!",
                            customClass: {
    ...
    const handleViewEvent = () => {
        ...
        viewEventLocation.setAttribute('href', data.eventLocation ? data.eventLocation : '--')
    ...
    const handleDeleteEvent = () => {
        viewDeleteButton.addEventListener('click', e => {
            ...
            Swal.fire({
                text: "Вы уверенны что хотите удалить этот урок?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "Да, удалить урок!",
    ...
    const handleCancelButton = () => {
        ...
        cancelButton.addEventListener('click', function (e) {
            ...
            Swal.fire({
                text: "Вы уверенны что хотите отменить?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "Да, отменить создание урока!",
                cancelButtonText: "Нет, я хочу продолжить!",
                customClass: {
                    confirmButton: "btn btn-primary",
                    cancelButton: "btn btn-active-light"
                }
                ...
                if (result.value) {
                    ...
                    Swal.fire({
                        text: "Вы не отменили создание урока!.",
                        icon: "error",
                        buttonsStyling: false,
                        confirmButtonText: "Хорошо!",
                        customClass: {
